...
Purpose of the this hands-on training is to give the DevOps quick introductory knowledge of how to create a Flask web application on local.

## Learning Outcomes

At the end of the this hands-on training, DevOps will be able to;
